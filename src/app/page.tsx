...
const COMMAND_GROUPS = [
  {
    ...
    commands: [
      ...
      { name: "update", desc: "Update task details" },
      { name: "delete", desc: "Remove a task" },
      { name: "start", desc: "Move to in-progress" },
      { name: "done", desc: "Mark as completed" },
      { name: "reset", desc: "Move back to todo" },
      { name: "block", desc: "Mark as blocked" },
      { name: "assign", desc: "Assign to an agent" },
    ],
  },
  {
    category: "Views",
    ...
    commands: [
      ...
      { name: "list", desc: "Flat list view" },
      { name: "show", desc: "Task detail view" },
      { name: "next", desc: "Next available task" },
      { name: "stats", desc: "Project statistics" },
    ],
  },
  {
    category: "Agents",
    icon: "🤖",
    commands: [
      { name: "claim", desc: "Agent claims a task" },
      { name: "log", desc: "Append to task log" },
